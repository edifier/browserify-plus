...
function listener(opts, cb) {
    ...
    function rule(file) {
        ...
        if ((extname === '.js' && opts.js) || (util.testRJS(file) && opts.rjs) || extname === '' || (extname === '.css' && opts.css)|| (util.testSCSS(file) && opts.scss) || (opts.image && opts.image.patterns.indexOf(extname) !== -1)) {
            return true;
        }
